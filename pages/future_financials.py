...
.box-column:nth-child(2) .box-cost{position:relative;z-index:2;width:calc(200% + 5px);border-radius:9px}@media(max-width:520px){.box-column:nth-child(2) .box-cost{width:calc(200% + 3px)}}
</style>
            ''',
            sanitize=False,
        ).classes("w-full")
