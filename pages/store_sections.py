            ...
            (() => {
              ...
              const start=e=>{
                ...
                timer=setTimeout(()=>{
                  ...
                  document.body.appendChild(ghost);card.setPointerCapture?.(pointerId);navigator.vibrate?.(30);
                },1000);
              };
              const move=e=>{
