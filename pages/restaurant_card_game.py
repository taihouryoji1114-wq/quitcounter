    ...
    def render():
        with ui.element("main").classes("rg-app"):
            ...
            if state["screen"] == "home":
                ...
                choices = {item_id: card(item_id)["name"] for item_id in profile["owned"]}
                choices[""] = "未配置"
