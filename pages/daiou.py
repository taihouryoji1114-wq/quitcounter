...
.map-parchment{fill:#17261e;stroke:#caa65a;stroke-width:4;filter:url(#map-shadow)}.outer-river{fill:none;stroke:#4f8592;stroke-width:20;opacity:.72}.old-road{fill:none;stroke:#d7ba75;stroke-width:4;stroke-dasharray:3 7;opacity:.45}.terrain-detail{pointer-events:none;opacity:.42;stroke:none}.detail-plain{fill:url(#plain-texture)}.detail-forest{fill:url(#forest-texture)}.detail-hill{fill:url(#hill-texture)}.detail-river{fill:url(#river-texture)}.terrain-line,.hill-mark,.water-mark{fill:none;stroke:#f4dda6;stroke-width:1.4;opacity:.45}.terrain-speck,.tree-mark{fill:#e8d39b;opacity:.42}.region-label{pointer-events:none;fill:#FFF3D0;font-size:12px;font-weight:950;paint-order:stroke;stroke:#101815;stroke-width:3px}.march-route{pointer-events:none;fill:none;stroke:#FFE17C;stroke-width:4;stroke-dasharray:9 7;filter:drop-shadow(0 0 4px rgba(255,209,89,.85));animation:marchFlow 1.1s linear infinite}.march-arrow{fill:#FFE17C}@keyframes marchFlow{to{stroke-dashoffset:-32}}
'''
