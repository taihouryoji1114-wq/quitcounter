...
def schedule_page():
    ...
    with content:
        ...
        .calendar-event.event-task{box-shadow:inset 3px 0 0 #fff;border-left:1px solid rgba(255,255,255,.8)}.calendar-event.event-task:after{content:' □';font-weight:900}.calendar-event.event-done{opacity:.5;text-decoration:line-through}.calendar-event.event-done:after{content:' ✓'}.day-dialog-event{display:grid!important;grid-template-columns:5px minmax(0,1fr) 40px!important;column-gap:10px!important}.day-dialog-event>.grow{width:100%!important;min-width:0!important;padding-right:0!important}.schedule-event-actions{width:40px!important;min-width:40px!important;position:relative!important;z-index:2!important}.schedule-event-actions .q-checkbox{width:36px!important;height:36px!important;margin:0!important}.event-row>.q-checkbox{position:relative!important;flex:0 0 36px!important;align-self:flex-start!important;margin:0!important}.event-row>.grow{min-width:0!important;padding-right:4px}.event-row .q-btn{flex:0 0 36px!important}.schedule-card-note{position:relative!important;z-index:0!important}
