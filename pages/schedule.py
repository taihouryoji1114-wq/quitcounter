...
def schedule_page():
    ...
    with content:
        ...
        .calendar-event.event-task{box-shadow:inset 3px 0 0 #fff;border-left:1px solid rgba(255,255,255,.8)}.calendar-event.event-task:after{content:' □';font-weight:900}.calendar-event.event-done{opacity:.5;text-decoration:line-through}.calendar-event.event-done:after{content:' ✓'}
