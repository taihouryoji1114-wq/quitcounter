...
def store_dashboard_page():
    ...
    with content:
        ...
        .prep-board-expansion{border-radius:17px!important;background:rgba(5,29,21,.19)!important;border:1px solid rgba(255,255,255,.13)!important}.prep-board-expansion>.q-expansion-item__container>.q-item{min-height:44px!important;color:#fff!important;font-size:11px;font-weight:950}.prep-board-expansion .q-expansion-item__content{padding:1px 7px 8px}.prep-icon-board{padding:8px 1px 2px!important;gap:7px!important;touch-action:pan-x pan-y}.prep-icon-guide{font-size:9px;font-weight:900;opacity:.78}.board-swipe-hint{font-size:8px;font-weight:800;opacity:.68}.prep-icon-pages{display:flex;overflow-x:auto;overscroll-behavior-x:contain;scroll-snap-type:x mandatory;scroll-behavior:smooth;-webkit-overflow-scrolling:touch;scrollbar-width:none;touch-action:pan-x pan-y;padding:2px 0 7px}.prep-icon-pages::-webkit-scrollbar{display:none}.prep-icon-page{position:relative;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));grid-template-rows:repeat(4,108px);grid-auto-flow:row dense;grid-auto-rows:108px;align-content:start;gap:9px;flex:0 0 100%;width:100%;min-width:100%;max-width:100%;height:483px;box-sizing:border-box;overflow:hidden;scroll-snap-align:start;scroll-snap-stop:always;padding:2px 2px 22px}.prep-icon{position:relative!important;display:flex!important;flex-direction:column!important;justify-content:space-between!important;min-width:0!important;width:100%!important;height:108px!important;min-height:108px!important;max-height:108px!important;overflow:hidden!important;padding:10px!important;cursor:pointer;border-radius:20px!important;color:#17382c!important;background:linear-gradient(145deg,rgba(255,255,255,.99),rgba(225,238,230,.97))!important;border:1px solid rgba(255,255,255,.92)!important;box-shadow:0 7px 16px rgba(1,24,17,.18)!important;transition:transform .16s ease,background .2s ease,color .2s ease!important;-webkit-tap-highlight-color:transparent;user-select:none}.prep-icon:active{transform:scale(.96)}.prep-icon-feature{grid-column:span 2;background:linear-gradient(135deg,#fffdf7,#f4ead1)!important;border-color:#f1d99f!important}.prep-icon-completed{color:#563b05!important;background:linear-gradient(145deg,#ffe991,#d9ac36)!important;border-color:#ffe286!important;box-shadow:0 7px 18px rgba(129,82,6,.23)!important}.prep-icon-progress{color:#5a3b05!important;background:linear-gradient(145deg,#fff2cc,#f0c574)!important;border-color:#f4d290!important}.prep-icon-symbol{font-size:22px!important;color:#2b7757}.prep-icon-completed .prep-icon-symbol,.prep-icon-progress .prep-icon-symbol{color:#855b08}.prep-icon-badge{font-size:17px!important;color:#a66c12}.prep-icon-name{display:-webkit-box;max-width:100%;max-height:34px;font-size:12px;font-weight:950;line-height:1.3;overflow:hidden;overflow-wrap:anywhere;-webkit-box-orient:vertical;-webkit-line-clamp:2}.prep-icon-status{flex:0 0 auto;max-width:100%;font-size:9px;font-weight:900;line-height:1.2;opacity:.72;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.prep-icon-checked-preview{display:-webkit-box;width:100%;max-height:21px;overflow:hidden;font-size:8px;font-weight:850;line-height:1.3;color:#806529;text-decoration:line-through;white-space:normal;overflow-wrap:anywhere;-webkit-box-orient:vertical;-webkit-line-clamp:2}.prep-page-number{position:absolute;left:50%;bottom:1px;transform:translateX(-50%);font-size:8px;font-weight:900;opacity:.62}.prep-detail-dialog{width:min(92vw,430px)!important;max-height:88vh;overflow-y:auto;border-radius:25px!important}.board-subcheck{font-size:11px;font-weight:850;padding:5px 2px;border-bottom:1px solid #eee}.board-subcheck:has(.q-checkbox__inner--truthy) .q-checkbox__label{text-decoration:line-through;color:#8b948f}.board-note .q-field__control{background:rgba(255,255,255,.88);border-radius:10px}.board-note-save{align-self:flex-end;color:#246A4E!important;font-size:8px!important}.notice-history{border:1px solid #E4E9E5!important;border-radius:16px!important;background:rgba(255,255,255,.9)!important}.notice-history .q-expansion-item__content{padding:3px 14px 10px}@media(min-width:700px){.prep-icon-page{grid-template-columns:repeat(4,minmax(0,1fr));grid-template-rows:repeat(2,118px);grid-auto-rows:118px;height:269px}.prep-icon,.prep-icon-feature{height:118px!important;min-height:118px!important;max-height:118px!important}.prep-icon-name{font-size:14px}}
        """)
        ui.run_javascript("""
