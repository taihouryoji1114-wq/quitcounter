...
def render_store_navigation():
    ...
    ui.add_css("""
    body{background:linear-gradient(180deg,rgba(244,247,244,.76),rgba(239,238,232,.88)),url('/static/store_ops_home_bg_v3.png') center top/cover no-repeat scroll!important}.today-ribbon{color:#527060;font-size:9px;font-weight:900;letter-spacing:.14em;margin-bottom:9px;padding-left:4px}.store-app-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px 12px}.store-app-card{position:relative;overflow:hidden;min-height:164px;border-radius:24px!important;border:1px solid rgba(255,255,255,.95)!important;box-shadow:0 9px 0 #d2d9d5,0 17px 28px rgba(39,55,45,.18)!important;background:linear-gradient(145deg,#fff,#f0f4f2)!important;transition:transform .13s ease,box-shadow .13s ease!important;cursor:pointer}.store-app-card:before{content:'';position:absolute;inset:1px 1px auto;height:45%;border-radius:23px 23px 50% 50%;background:linear-gradient(180deg,rgba(255,255,255,.72),transparent);pointer-events:none}.store-app-card:after{content:'›';position:absolute;right:14px;bottom:9px;font-size:29px;color:rgba(31,54,44,.32)}.store-app-card:active{transform:translateY(5px) scale(.99);box-shadow:0 4px 0 #c9d1cd,0 9px 17px rgba(39,55,45,.16)!important}.store-app-grid>.store-app-card:nth-child(1){background:linear-gradient(145deg,#f8fbff,#e8f2ff)!important;box-shadow:0 9px 0 #bfd2e7,0 17px 28px rgba(39,55,45,.18)!important}.store-app-grid>.store-app-card:nth-child(2){background:linear-gradient(145deg,#fffdf5,#fff1c9)!important;box-shadow:0 9px 0 #e2cb8f,0 17px 28px rgba(39,55,45,.18)!important}.store-app-grid>.store-app-card:nth-child(3){background:linear-gradient(145deg,#fff9f7,#ffe7df)!important;box-shadow:0 9px 0 #e6b8aa,0 17px 28px rgba(39,55,45,.18)!important}.store-app-grid>.store-app-card:nth-child(4){background:linear-gradient(145deg,#fbf9ff,#eee7ff)!important;box-shadow:0 9px 0 #cbbce9,0 17px 28px rgba(39,55,45,.18)!important}.store-more-title{font-size:13px;font-weight:950;color:#27493a}.store-more-hint{font-size:8px;font-weight:850;color:#718078}.store-app-rail{display:flex;gap:13px;overflow-x:auto;scroll-snap-type:x proximity;-webkit-overflow-scrolling:touch;scrollbar-width:none;padding:3px 2px 18px}.store-app-rail::-webkit-scrollbar{display:none}.store-app-rail>.store-app-card{flex:0 0 57%;min-height:138px!important;scroll-snap-align:start;padding:17px!important;background:linear-gradient(145deg,#fbfffd,#e6f3ed)!important;box-shadow:0 8px 0 #c1d5cc,0 15px 25px rgba(39,55,45,.16)!important}.store-app-badge{position:absolute;z-index:3;right:13px;top:12px;display:grid;place-items:center;min-width:25px;height:25px;padding:0 7px;border-radius:999px;background:#E43F3F;color:#fff;font-size:11px;font-weight:950}@media(min-width:700px){.store-app-rail>.store-app-card{flex-basis:31%}}
    """)
