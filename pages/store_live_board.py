...
def render_live_board(business_date, period, period_label):
    ...
    ui.add_css("""
    .live-board-v2{padding:18px 16px 12px!important;border:1px solid #dfe8e2!important;border-radius:24px!important;background:rgba(255,255,255,.97)!important;color:#17352b!important;box-shadow:0 14px 34px rgba(30,61,48,.13)!important}
    ...
    .live-board-section{padding-top:15px}.live-board-category{width:100%;padding:0 3px 7px;color:#587064;font-size:11px;font-weight:950;letter-spacing:.08em;border-bottom:2px solid #dce7e1}.live-board-item{padding:12px 2px;border-bottom:1px solid #edf1ef}.live-board-copy{min-width:0;flex:1}.live-board-name{font-size:14px;font-weight:900;line-height:1.3;overflow-wrap:anywhere}.live-board-note{margin-top:3px;color:#a06b18;font-size:10px;font-weight:800;line-height:1.3}.live-board-controls{gap:5px!important;flex:0 0 auto;margin-left:8px}
    .live-completion-button{min-width:72px!important;min-height:42px!important;border-radius:12px!important;font-size:11px!important;font-weight:950!important}.live-completion-button.is-pending{color:#65736d!important;background:#f0f3f1!important}.live-completion-button.is-done{color:#17623e!important;background:#e2f3e9!important}
