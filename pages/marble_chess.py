...
def marble_chess_page():
    ...
    <main id="mc-app" class="mc-app">
      ...
      <section id="mc-formation-page" class="mc-page hidden"><header><button data-back>‹</button><div><small>FORMATION</small><b>布陣</b></div><i></i></header><div class="mc-page-body"><h2>8体のポーンを選ぶ</h2><p>配置段階から戦略が始まります。各枠をタップして個体を変更。</p><div class="mc-budget"><span>編成コスト</span><b><em id="mc-cost">0</em> / 100</b></div><div id="mc-pawn-slots" class="mc-pawn-slots"></div><div class="mc-trait-legend"><b>個体一覧</b><span>衛兵：高HP・王の隣で防御強化</span><span>突撃：高攻撃・低防御</span><span>白兵：標準性能・低コスト</span></div></div></section>
