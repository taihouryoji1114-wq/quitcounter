...
@media print{@page{size:A4 portrait;margin:10mm}body{background:#fff!important;color:#111!important;-webkit-print-color-adjust:exact;print-color-adjust:exact}.report-controls,.q-header,.q-drawer,.q-btn{display:none!important}.app-shell{width:100%!important;max-width:none!important;padding:0!important}.app-shell>div:first-child,.app-shell>div:nth-child(2),.app-shell>div:nth-child(3){display:none!important}.print-report{border:0!important;padding:0!important;color:#111!important}.report-title{font-size:20pt!important;color:#102B21!important}.report-period{font-size:10pt!important;color:#222!important}.report-metric-label,.ratio-card{font-size:9pt!important;color:#222!important}.report-metric-value,.ratio-value{font-size:13pt!important;color:#111!important}.report-section-title{font-size:14pt!important;color:#111!important}.report-table-wrap{overflow:visible}.report-table{font-size:9pt!important;color:#111!important}.report-table th,.report-table td{padding:6px 5px!important;border-color:#777!important}.report-table th{color:#111!important}.report-table tr{break-inside:avoid}.report-section-title{break-after:avoid}.report-block-map,.ratio-grid,.report-metrics{break-inside:avoid}.report-block-map{height:68mm}.report-block-title{font-size:9pt!important}.report-block-value{font-size:10pt!important}.report-block-note{font-size:7.5pt!important}}
"""
